...
| `rud_daily` | (snapshot_date, departamento, municipio) | RUD por municipio y día de captura — la serie oficial, y **la única fuente de los totales que se publican** (su último corte). **Captura cerrada desde el 18-sep-2026** (`ungrd_rud.CAPTURA_CERRADA`): la última etiqueta es el 17-sep |
