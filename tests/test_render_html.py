...
class TestDescubrimiento(unittest.TestCase):
    ...
    def test_llms_full_lleva_las_cifras_en_locale_es_co(self):
        ...
        formato: lo que vigila es el locale es-CO, no una cifra concreta. Se
        exige la forma —coma decimal, punto de millar— y se conserva un
        literal estable, la población que proyecta el DANE, que no cambia con
        cada corrida."""
