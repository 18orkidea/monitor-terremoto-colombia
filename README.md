...
| [Sedes educativas MEN (SISE)](https://mineducacion.maps.arcgis.com/apps/dashboards/5e47f09f3b374396a5b3be15e8e96192) (capa ArcGIS `SISE202608_Priorizadas_Final`) | **La primera fuente oficial sede a sede**: 9.273 sedes educativas geolocalizadas con matrícula y estado físico declarado tras el sismo (28-ago-2026: 17 en colapso total, 113 en riesgo inminente de colapso, 104 en colapso parcial, 288 con afectación parcial, 306 con afectación menor, 159 que reportan afectación sin definir el impacto, 197 sin afectación). Donde el EDAN dice «12 centros educativos», esto dice cuáles y dónde. **8.089 de 9.273 están en 'No aporta información' — sin verificar, que no es «sin daño»** | Público, sin clave; licencia no declarada (el item ArcGIS publica `licenseInfo` vacío, verificado 28-ago). **La capa se republica y muta en horas**: el 28-ago pasó de ~50.000 filas y 7 categorías a 9.273 y 8 entre dos sondas — comprobación diaria obligatoria, archivando solo lo que cambia; vigilada por test de supuesto |
